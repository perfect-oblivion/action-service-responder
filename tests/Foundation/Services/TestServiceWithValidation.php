...
class TestServiceWithValidation extends Service
{
    ...
    /** @var \PerfectOblivion\ActionServiceResponder\Tests\Foundation\Services\TestServiceValidator */
    protected $validator;

    /**
     * Construct a new TestServiceWithValidator.
     *
     * @param  \PerfectOblivion\ActionServiceResponder\Tests\Foundation\Services\TestServiceValidator  $validator
     */
