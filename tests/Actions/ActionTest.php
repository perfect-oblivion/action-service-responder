...
class ActionTest extends TestCase
{
    ...
    /** @test */
    function an_action_returns_a_response()
    {
    ...
    /** @test */
    function can_run_service_via_service_caller()
    {
        $response = $this->withExceptionHandling()
    ...
    /** @test */
    function can_run_service_via_static_call_helper()
    {
        $response = $this->withExceptionHandling()
    ...
    /** @test */
    function can_autorun_a_service_from_an_action()
    {
        $response = $this->withExceptionHandling()
    ...
    /** @test */
    function can_resolve_and_run_a_service_that_does_not_autorun()
    {
        $response = $this->withExceptionHandling()
